 ...
 */
package br.com.aem_typescript.core.models;
...
import br.com.aem_typescript.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem_typescript/components/helloworld");
